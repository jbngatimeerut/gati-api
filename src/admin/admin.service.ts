...
export const FEATURES = [
  ...
  { key: 'MESSAGING', label: 'Messaging', description: 'Send direct messages to other members' },
...
export class AdminService {
  ...
  async members() {
    ...
    const members = rows.map(({ premiumCategory, ...rest }) => ({ ...rest, premiumColor: premiumCategory?.active ? premiumCategory.color : null }));
  ...
  async grantById(feature: string, memberId: string) {
